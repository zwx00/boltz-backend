...
goog.object.extend(proto, lnd_rpc_pb);
...
proto.routerrpc.SendPaymentRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lnd_rpc_pb.RouteHint.toObject, includeInstance),
...
proto.routerrpc.SendPaymentRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new lnd_rpc_pb.RouteHint;
      reader.readMessage(value,lnd_rpc_pb.RouteHint.deserializeBinaryFromReader);
...
proto.routerrpc.SendPaymentRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      10,
      f,
      lnd_rpc_pb.RouteHint.serializeBinaryToWriter
    );
  }
...
proto.routerrpc.SendPaymentRequest.prototype.getRouteHintsList = function() {
  return /** @type{!Array<!proto.lnrpc.RouteHint>} */ (
    jspb.Message.getRepeatedWrapperField(this, lnd_rpc_pb.RouteHint, 10));
};
...
proto.routerrpc.SendToRouteRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    paymentHash: msg.getPaymentHash_asB64(),
    route: (f = msg.getRoute()) && lnd_rpc_pb.Route.toObject(includeInstance, f)
  };
...
proto.routerrpc.SendToRouteRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new lnd_rpc_pb.Route;
      reader.readMessage(value,lnd_rpc_pb.Route.deserializeBinaryFromReader);
      msg.setRoute(value);
      break;
    default:
      reader.skipField();
...
proto.routerrpc.SendToRouteRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      lnd_rpc_pb.Route.serializeBinaryToWriter
    );
  }
};
...
proto.routerrpc.SendToRouteRequest.prototype.getRoute = function() {
  return /** @type{?proto.lnrpc.Route} */ (
    jspb.Message.getWrapperField(this, lnd_rpc_pb.Route, 2));
};
...
proto.routerrpc.SendToRouteResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    failure: (f = msg.getFailure()) && lnd_rpc_pb.Failure.toObject(includeInstance, f)
  };
...
proto.routerrpc.SendToRouteResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new lnd_rpc_pb.Failure;
      reader.readMessage(value,lnd_rpc_pb.Failure.deserializeBinaryFromReader);
...
proto.routerrpc.SendToRouteResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      lnd_rpc_pb.Failure.serializeBinaryToWriter
    );
  }
};
...
proto.routerrpc.SendToRouteResponse.prototype.getFailure = function() {
  return /** @type{?proto.lnrpc.Failure} */ (
    jspb.Message.getWrapperField(this, lnd_rpc_pb.Failure, 2));
};
...
proto.routerrpc.BuildRouteResponse.prototype.getRoute = function() {
  return /** @type{?proto.lnrpc.Route} */ (
    jspb.Message.getWrapperField(this, lnd_rpc_pb.Route, 1));
};
...
proto.routerrpc.PaymentStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lnd_rpc_pb.HTLCAttempt.toObject, includeInstance)
  };
...
proto.routerrpc.PaymentStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 4:
      var value = new lnd_rpc_pb.HTLCAttempt;
      reader.readMessage(value,lnd_rpc_pb.HTLCAttempt.deserializeBinaryFromReader);
      msg.addHtlcs(value);
      break;
    default:
      reader.skipField();
...
proto.routerrpc.PaymentStatus.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      lnd_rpc_pb.HTLCAttempt.serializeBinaryToWriter
    );
  }
};
...
proto.routerrpc.PaymentStatus.prototype.getHtlcsList = function() {
  return /** @type{!Array<!proto.lnrpc.HTLCAttempt>} */ (
    jspb.Message.getRepeatedWrapperField(this, lnd_rpc_pb.HTLCAttempt, 4));
};
...
proto.routerrpc.UpdateChanStatusRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    chanPoint: (f = msg.getChanPoint()) && lnd_rpc_pb.ChannelPoint.toObject(includeInstance, f),
    action: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.routerrpc.UpdateChanStatusRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new lnd_rpc_pb.ChannelPoint;
      reader.readMessage(value,lnd_rpc_pb.ChannelPoint.deserializeBinaryFromReader);
...
proto.routerrpc.UpdateChanStatusRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      lnd_rpc_pb.ChannelPoint.serializeBinaryToWriter
    );
  }
  f = message.getAction();
  if (f !== 0.0) {
...
proto.routerrpc.UpdateChanStatusRequest.prototype.getChanPoint = function() {
  return /** @type{?proto.lnrpc.ChannelPoint} */ (
    jspb.Message.getWrapperField(this, lnd_rpc_pb.ChannelPoint, 1));
};
