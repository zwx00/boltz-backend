...
describe('VersionCheck', () => {
  ...
  test('should check version of LND clients', () => {
    ...
    expect(() => VersionCheck.checkLndVersion(symbol, '0.10.4-beta'))
      .toThrow('unsupported BTC LND version: 0.10.4-beta; max version 0.13.0; min version 0.12.0');

    expect(() => VersionCheck.checkLndVersion(symbol, '0.13.1-beta'))
      .toThrow('unsupported BTC LND version: 0.13.1-beta; max version 0.13.0; min version 0.12.0');
